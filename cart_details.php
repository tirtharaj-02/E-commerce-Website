...
if(isset($_SESSION['user'])){
    ...
    try{
        ...
        foreach($stmt as $row){
            ...
            $price_npr = $row['price'] * $usd_to_npr_rate;
            $subtotal = $price_npr * $row['quantity'];
            $total += $subtotal;
            $output .= "
                <tr>
                    ...
                    <td>".$row['name']."</td>
                    <td>रू ".number_format($price_npr, 2)."</td>
                    ...
                    <td>रू ".number_format($subtotal, 2)."</td>
                </tr>
            ";
        }
        $output .= "
            <tr>
                ...
                <td><b>रू ".number_format($total, 2)."</b></td>
            <tr>
        ";
    ...
    if(count($_SESSION['cart']) != 0){
        ...
        foreach($_SESSION['cart'] as $row){
            ...
            $price_npr = $product['price'] * $usd_to_npr_rate;
            $subtotal = $price_npr * $row['quantity'];
            $total += $subtotal;
            $output .= "
                <tr>
